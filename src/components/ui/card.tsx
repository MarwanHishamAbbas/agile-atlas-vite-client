...
function Card({
    ...
    const defaultProps = {
        className: cn(
            "relative flex flex-col rounded-2xl  bg-card not-dark:bg-clip-padding text-card-foreground before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-2xl)-1px)]",
            className,
        ),
        "data-slot": "card",
    };
...
function CardTitle({
    ...
    const defaultProps = {
        className: cn("label-lg font-medium text-neutral-500 leading-none", className),
