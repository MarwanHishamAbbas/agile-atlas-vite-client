...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'file:text-foreground placeholder:text-netural-400 selection:bg-primary placeholder:text-sm selection:text-primary-foreground  border-input h-10 w-full min-w-0 rounded-xl border px-3 py-1 text-base  transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
        'focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-2',
