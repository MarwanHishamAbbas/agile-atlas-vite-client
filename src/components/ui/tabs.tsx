...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "relative z-0 flex w-fit items-center justify-center gap-x-0.5 text-neutral-500 h-9",
        "data-[orientation=vertical]:flex-col",
        variant === "default"
          ? "rounded-lg bg-neutral-50 p-0.5 text-neutral-500"
    ...
    >
      ...
      <TabsPrimitive.Indicator
        className={cn(
          "-translate-y-1 absolute bottom-0 left-0 h-7 w-(--active-tab-width) translate-x-(--active-tab-left) transition-[width,translate] duration-200 ease-in-out",
          variant === "underline"
