...
function RouteComponent() {
    ...
    const form = useAppForm({
        ...
        onSubmit: async ({ value: values }) => {
            ...
            await resetPassword.mutateAsync({ password: values.password, verificationCode: code });
        }
    })
    ...
    return <div className='max-w-md mx-auto space-y-6 text-center'>
        ...
        <div className='space-y-2'>
            ...
            <p className='label-sm text-neutral-400'>Create a new password for your account.</p>
        </div>
        <form
            ...
            <form.AppForm>
                <form.SubscribeButton isLoading={resetPassword.isPending} label="Reset" className='w-full' />
            </form.AppForm>
